 ...
 function Dashboard() {
  ...
  return (
    <Box sx={{ display: 'flex'}} >
      ...
      <AppBar
        position="fixed"
        sx={{ width: `calc(100% - ${drawerWidth}px)`, ml: `${drawerWidth}px` ,background: 'transparent', boxShadow: 'none'}}
      >
        <Toolbar>
          <Typography
            variant="h6"
      ...
      >
        ...
        <Grid item xs={12} sm={6} style={{borderRadius:'0.5rem', color:'white', backgroundColor: '#382B57',width: '100%', height: '18.50rem', objectFit: 'cover'}}>
          <Grid style={{position: "absolute",margin: '56px 32px'}}>
            <Typography  style={{width: '365px',height: '120px',fontFamily: 'Inter',fontStyle: 'normal',fontWeight: '600',fontSize: '32px',lineHeight: '40px'}}>
              Plataforma exclusiva para compartilhamento de conteúdos
            </Typography> 
            <Typography style={{width: '365px',height: '48px',fontFamily: 'Open Sans',fontStyle: 'normal',fontWeight: '400',fontSize: '16px',lineHeight: '24px'}} paragraph>
