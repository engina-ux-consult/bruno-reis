          ...
          >
            ...
            <Box>
              ...
              <p>
                ...
                Parte inorgânica: Vidro de fluor-alumino-silicato e silica com
                77% em peso <br />
            ...
            <Box>
              ...
              <p>
                ...
                Parte inorgânica: Aluminosilicato de estrôncio, sílica com 77%
                em peso <br />
            ...
            <Box id="VOCO" className="index_selection">
              ...
              <Box>
                ...
                <p>
                  ...
                  Parte inorgânica: Nanopartículas de dióxido de silício e
                  partículas híbridas à base de óxido de silício com 84% em peso
                  <br />
                ...
                <ul>
                  ...
                  <li>
                    Reparação de facetas, pequenos defeitos no esmalte e
                    materiais especiais para coroas e pontes provisórias
                  </li>
              ...
              <Box>
                ...
                <p>
                  ...
                  Parte inorgânica: Partículas de vidro cerâmico (1 μm) e
                  dióxido de silício (20–40 nm) com 89% em peso e 73% em volume
                </p>
                ...
                <ul>
                  ...
                  <li>
                    Fixação em bloco ou ferulização de dentes com mobilidade.
                  </li>
              ...
              <Box id="DGM" className="index_selection">
                ...
                <Box>
                  ...
                  <p>
                    ...
                    Parte inorgânica: Dióxido de silício com 65% em volume{" "}
                    <br />
                  ...
                  <ul>
                    <li>
                      Restaurações diretas em dentes permanentes e decíduos
                    </li>
                    <li>
                      Confecção de núcleo, pequenas restaurações de cavidades
                      classes III, IV e V
                    </li>
                    <li>
                      Material de base da cavidade e selamento de fissuras{" "}
                    </li>
                  </ul>
                  <h2>Apresentação de cores e opacidades:</h2>
                  <Image
                ...
                <Box id="KURARAY" className="index_selection">
                  ...
                  <Box>
                    ...
                    <p>
                      ...
                      Parte inorgânica: vidro de bário e sílica coloidal com 86%
                      em peso <br />
                    ...
                    <ul>
                      <li>
                        Restaurações para todas as classes de cavidades em
                  ...
                  <Box id="COLTENE" className="index_selection">
                    ...
                    <Box>
                      ...
                      <p>
                        ...
                        <br />
                        Parte inorgânica: Pó de vidro de bário, sílica e óxido
                        de zinco com 56% em volume e 74% em peso <br />
                      ...
                      <ul>
                        <li>
                          Indicado para restaurações diretas e indiretas em
                          dentes anteriores e posteriores, vedação e reparação
                          de restaurações de compósitos, além de correções
                          estéticas de formato e cor.
                        </li>
                      </ul>
                      <h2>Apresentação de cores e opacidades:</h2>
                      <Image
                    ...
                    <Box id="VIGODENT" className="index_selection">
                      ...
                      <Box>
                        ...
                        <p>
                          ...
                          Tamanho médio das partículas: Não disponível na
                          literatura <br />
                        </p>
                        ...
                        <ul>
                          <li>
                            Restaurações diretas de resina em dentes posteriores
                            e anteriores.
                          </li>
                        </ul>
