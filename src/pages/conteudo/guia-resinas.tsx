          ...
          >
            ...
            <>
              ...
              <p>
                ...
                e/ou alifáticos:
                <br />
                Os principais monômeros utilizados nas resinas compostas e suas
              ...
              />
              <p>
                Monômeros que são adicionados para melhorar a manipulação e suas
                respesctivas características:
              </p>
              <img
              ...
              <p>
                ...
                compósito).
                <br />
                Entre eles estão os chamados de “vidros moles” e “vidros duros”
                de borossilicato, quartzo fundido, silicato de alumínio,
                silicato de lítio-alumínio (beta eucriptita, que tem coeficiente
                de expansão térmica linear negativo), fluoreto de itérbio e
                vidros de bário (Ba), estrôncio (Sr), zircônio (Zr) e zinco
                (Zn). Os últimos 5 tipos também conferem radiopacidade em
                virtude de seus átomos de metais pesados.
              ...
              <p style={gray}>
                Partículas maiores, como nas resinas macroparticuladas, o volume
                de carga é menor, pois é difícil que as partículas se encaixem e
                preencham todos os espaços. Quando passamos para resinas que
                contém partículas menores, sendo elas híbridas ou não, todos os
                espaços passam a ser melhores preenchidos, garantindo um
                excelente volume de carga e, consequentemente, uma maior
                resistência.
              </p>
              <h2>Ou seja:</h2>
              <img
              ...
              <p>
                ...
                resinosa.
                <br />
                Um agente de união corretamente aplicado também pode contribuir
                para melhores propriedades físicas e químicas e inibir a
                lixiviação através da prevenção da penetração de água ao longo
                da interface partícula-resina. Apesar de titanatos e zirconatos
                poderem ser usados como agentes de união, organo-silanos (como
                γ-metacriloxipropiltrimetoxi silano) são mais comumente usados.
              </p>
              <p style={gray}>
                Além desses componentes principais, as resinas compostas contêm
                vários outros componentes, incluindo sistemas
                ...
                são adicionados para conferir cor próxima do dente. Absorventes
                ultravioleta (UV) e outros aditivos são incorporados para
                melhorar a estabilidade de cor, inibidores de polimerização
                estendem o período de validade e aumentam o tempo de trabalho,
                especialmente para resinas quimicamente ativadas. Outros
                componentes podem ser incluídos para melhorar o desempenho, a
                aparência e a durabilidade.
              </p>
              <img
              ...
              <p>
                ...
                <br />
                <br />
                Microparticuladas: por não possuírem grande quantidade de carga,
                não devem ser utilizadas em áreas de concentração de forças,
                como em dentes posteriores ou na face palatina de dentes
                anteriores.
                <br />
                <br />
                ...
                resinas não interfere na sua indicação, mas podem interferir em
                outras características, como na técnica de polimento e
                manutenção.
                <br />
                <br />
              ...
              <p style={gray}>
                ...
                fabricantes seguem essa regra do exemplo acima. O valor costuma
                ser descrito em primeiro ou último lugar (A2D ou DA2, por
                exemplo).
              </p>
              ...
              <h2>Observações:</h2>
              <p style={gray}>
                1: Este conteúdo apresenta a média dos preços atuais de resinas
                compostas de diferentes marcas comerciais. Essa média foi
                calculada a partir dos valores disponíveis nos sites da Dental
                Surya, Dental Cremer e Dental Speed.
              </p>
              <p style={gray}>
            ...
            <>
              ...
              <ul>
                <li>
                  Restaurações em dentes anteriores e posteriores (Classes I,II,
                  III, IV e V);
                </li>
            ...
            <>
              ...
              <ul>
                <li>
                  ...
                  posteriores (Classes I, II, III, IV e V) incluindo superfícies
                  oclusais;
                </li>
                <li>
            ...
            <>
              ...
              <p>
                ...
                zircônia não-aglomerada/não-agregada, aglomerados de zircônia e
                sílica e aglomerados de partículas nanométricas de itérbio com
                aproximadamente 76,5% em peso e 58,4% em volume tamanho das
                partículas: 100% de nanopartículas de até 100 nm
              </p>
              <h2>Indicação:</h2>
              <ul>
                <li>
            ...
            <>
              ...
              <h2>Composição:</h2>
              <p>
                Matriz orgânica: Bis-GMA (Bis-Fenol A di-Glicidil Metacrilato),
                BisEMA (Bis-Fenol A di-Glicidil Metacrilato etoxilado), TEGDMA
                (Trietileno glicol dimetacrilato), UDMA (Uretano dimetacrilato),
                canforquinona, co-iniciador e silano. Matriz inorgânica: vidro
                de bário-alumino silicato silanizado, pigmentos e sílicas.{" "}
                <br />
            ...
            <>
              ...
              <h2>Indicação:</h2>
              <p>
                Indicada para todas as classes de cavidade em dentes anteriores
                e posteriores.
              </p>
              <h2>Apresentação de cores e opacidades:</h2>
              <img
            ...
            <>
              ...
              <p>
                ...
                Diglicidil Dimetacrilato Etoxilado (Bis-EMA) e Uretano
                Dimetacrilato (UDMA).
                <br />
            ...
            <>
              ...
              <p>
                ...
                facetas diretas. Sua resistência mecânica também permite que
                seja indicada para o uso em dentes posteriores.
              </p>
              <h2>Apresentação de cores e opacidades:</h2>
              <img
            ...
            <>
              ...
              <h2>Composição:</h2>
              <p>
                <h3>Matriz orgânica:</h3> matriz de metacrilato (Bis-GMA, UDMA,
                TEGDMA)
                <br />
            ...
            <>
              ...
              <p>
                ...
                <br />
                <br />
                A solução ENAMEL PLUS HRI - O mesmo índice de refração do que o
                esmalte natural
                <br />
                <br />
                ...
                Classic - Saúde bucal nas melhores mãos - Kulzer Mitsu Chemicals
                Group
                <br />
                <br />
                Charisma Informação do produto - Charisma Diamond - Descubra um
                novo conceito em beleza natural - Saúde nas melhores mãos -
                ...
                <br />
                <br />
                Catálogo Ultradent - 2017 COVER PORTUGUESE.indd 1 - página 16 e
                40 a 44 -
                <br />
                <br />
                ...
                <br />
                <br />
                Material de restauração foto-polimerizável e de alta estética de
                acordo com 24049/ISO 4049
                <br />
                <br />
              </p>
            </>
